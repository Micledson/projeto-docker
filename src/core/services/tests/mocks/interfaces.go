...
func (m *MockTodoAdapter) Update(arg0 todo.Todo) errors.Error {
	m.ctrl.T.Helper()
...
func (mr *MockTodoAdapterMockRecorder) Update(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockTodoAdapter)(nil).Update), arg0)
}
